...
./02_test-all-scenarios.sh --version 26.7.1
...
Options:
  --version VERSION       Test specific package version (default: latest)
                          ...
                          stable release. Pin (e.g. "26.7.1") for reproducible
                          / shared / CI runs.
...
Examples:
  ...
  # Pin to 26.7.1 with custom license
  ./02_test-all-scenarios.sh --version 26.7.1 --license /path/to/lic
...
Examples:
  ...
  ./03_test-docker-compose.sh --version 26.7.1
...
```bash
for version in 26.4.3 26.7.1 26.5.0 latest; do
